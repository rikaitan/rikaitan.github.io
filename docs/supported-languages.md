...
If you want to add or improve support for a language, consider looking at the [language features documentation at GitHub](https://github.com/Ajatt-Tools/rikaitan/blob/main/docs/development/language-features.md).
